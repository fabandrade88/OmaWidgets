...
var PodsView = require("../model/PodsView.js")
...
t.eq(PodsView.noiseModeName(pods.noiseMode), "Transparency", "the noise mode maps to its name")
t.eq(PodsView.lowestPodLevel(pods), 58, "the lowest pod level excludes the case")
t.eq(PodsView.hasAnyBattery(pods), true, "battery readings count even while disconnected")
